...
describe Sprockets::Developer::Path do
  describe "Meta Requests" do
    subject { Sprockets::Developer::Path.new("app/assets/javascripts/test.coffee", "meta") }
  ...
  describe "Content Requests" do
    subject { Sprockets::Developer::Path.new("app/assets/javascripts/test.coffee", "content") }
    it { is_expected.not_to be_meta }
    it { is_expected.not_to be_not_found }
  end

  describe "Responses for paths" do
    let(:not_found) { Sprockets::Developer::Path.new("/stylish/content/whatever") }
    let(:coffeescript) { Sprockets::Developer::Path.new("app/assets/javascripts/test.coffee", "meta") }
    let(:scss) { Sprockets::Developer::Path.new("app/assets/stylesheets/test.css.scss", "meta") }
